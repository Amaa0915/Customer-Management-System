...
const Userprofile = () => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:3010/api/customers/663c3cf8ba9ffaef9860d6de`)
            .then((res) => {
                setCusData(res.data);
            })
            .catch(() => {
    ...
    const handleSave = () => {
        axios.put(`http://localhost:3010/api/customers/${cusData._id}`, cusData)
            .then(() => {
                setIsEditing(false);
                    ...
                    <div className="container-fluid">
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                ...
                                <li className="nav-item">
                                    <Link className="btn btn-danger">SHOP NOW</Link>
                                </li>
                                <li className="nav-item">
                                    <Link to className="btn btn-danger">BOOK NOW</Link>
                                </li>
                                <li className="nav-item">
                                    <Link className="btn btn-danger">EMERGENCY</Link>
                                </li>
